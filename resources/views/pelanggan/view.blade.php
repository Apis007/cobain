    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button class="btn btn-sm btn-success btn-form" data-url="{{route('pelanggan.add')}}" title="Tambah Data"><i class="fa fa-plus"></i> Tambah</button>
            </div>
        </div>
        <div class="card-body">
...
@push('js')
    ...
    <script>
        var tbl = new DataTable('#datatable',{
            ...
            serverSide: true,
            ajax:{
                url: '{{route("pelanggan.data")}}', type:'POST'
            },
            columns:[
                {data:'nama'},
                {data:'alamat'},
